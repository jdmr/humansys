...
<div class="Curso">
    <h1>Edita Curso <c:out value="${curso.nombre}"/></h1>
    <portlet:actionURL var="actionUrl">
        <portlet:param name="action" value="editaCurso"/>
    </portlet:actionURL>
    ...
    <form:form name="cursoForm" commandName="curso" method="post" action="${actionUrl}" >
        ...
        <div class="buttons">
            <span class="button"><input type="submit" name="_actualiza" class="save" value="Actualiza"/></span>
        </div>
    </form:form>
